...
class NewJournalView: UIView {
    ...
    func initConstraints() {
        NSLayoutConstraint.activate([
            ...
            journalTextView.leadingAnchor.constraint(equalTo: journalTitleTextField.leadingAnchor),
            journalTextView.trailingAnchor.constraint(equalTo: journalTitleTextField.trailingAnchor),
